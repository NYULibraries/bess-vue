    ...
    window[ "webpackJsonp" ] = window[ "webpackJsonp" ] || []
        ...
        "09b8"    : function ( t, e, a ) {
            ...
            var s = function () {
                                ...
                                attrs : {
                                    ...
                                    gutter : 30
                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                 t._l( t.serviceCards, (
                                                                                                                                                                                                                                                                                                                                                                     function ( a ) {
                                                                                                                                                                                                                                                                                                                                                                         return [
                                                                                                                                                                                                                                                                                                                                                                             t.isValidCardType( a ) ? e( "basic-card", {
                                                                                                                                                                                                                                                                                                                                                                                 key   : a.id,
                                                                                                                                                                                                                                                                                                                                                                                 attrs : { content : a }
                                              ...
                                              attrs : {
                                                  ...
                                                  titleText : "Settings"
                                                               ...
                                                               e( "div", { staticClass : "options" }, [
                                                                   t.feed && t.content && null != t.content.feedType && 0 == t.feed.needsGoogleAuth ? e( "div", { staticClass : "option" }, [
                                                                       e( "h3", { staticClass : "max" }, [ t._v( "Maximum items to show" ) ] ), t.feed && t.content && null != t.content.feedType && 0 == t.feed.needsGoogleAuth ? e( "range-slider", {
                                                                           attrs : { startVal : t.maxItems },
                                                                           on    : {
                                                                   ...
                                                                   ], 1 ) : t._e(), e( "div", { staticClass : "option" }, [
                    ...
                    a( "7f7f" ), function () {
                        var t = this, e = t._self._c;
                        return e( "div", { staticClass : "slidecontainer" }, [
                            e( "div", { staticClass : "slide-range" }, [
                                e( "input", {
                                    directives  : [
                                        {
                                            name       : "model",
                                ...
                                } ), e( "div", { staticClass : "range-value" }, [ t._v( t._s( t.rangeVal ) + " " + t._s( t.unit ) ) ] )
                            ] ), e( "div", { staticClass : "min-max" }, [
                                e( "span", {
                                    staticClass : "min",
                ...
                m = h.exports, v = a( "b963" ), g = a( "9ce6" ), C = a.n( g ),
                _ = (
                    a( "b54a" ), function () {
                        var t = this, e = t._self._c;
                        return e( "div", { staticClass : "notification" }, [
                            t.notification && !t.google ? e( "div", { staticClass : "not-google" }, [
                                e( "div", {
                            ...
                            ] ) : t._e(), t.google ? e( "div", { staticClass : "google" }, [
                                t._m( 0 ), e( "div", { staticClass : "bottom-section" }, [
                                    e( "a", {
                                        staticClass : "dismiss",
                                        attrs       : {
                                            href         : "/",
                                        ...
                                        on          : {
                                            click : function ( e ) {
                                                return e.preventDefault(), t.dismissGoogle()
                                            }
                                        }
                                    } ), e( "a", {
                                        staticClass : "go-now",
                                    ...
                                    } ), e( "div", { staticClass : "google-image" } )
                                ] )
                            ] ) : t._e()
                        ] )
                    }
                    ...
                    function () {
                        var t = this, e = t._self._c;
                        return e( "div", { staticClass : "top-text" }, [ e( "h3", [ t._v( "CONNECT TO GOOGLE" ) ] ), e( "p", [ t._v( "In order to display information from your Google Applications, NYU Home will need access to your NYU Google account. Link to your account?" ) ] ) ] )
                    }
                ], b = {
                    ...
                    props    : {
                        notification           : null,
                        google                 : { default : !1 },
                        hasRefreshTokenExpired : { default : !1 }
                    },
                    data     : function () {
                        return { dismissed : !1 }
                    },
                    ...
                    a( "cf2a" ), Object( p[ "a" ] )( w, _, y, !1, null, "409cce4c", null )
                ), D = T.exports, k = function () {
                    var t = this, e = t._self._c;
                    return e( "div", { staticClass : "feed-contain" }, [
                        t.feed && t.feed.items.length > 0 ? e( "ul", t._l( t.feed.items, (
                            function ( a, s ) {
                                return e( "li", { key : s }, t._l( a.rows, (
                                    function ( a, s ) {
                                        return e( "div", {
                                            key         : s,
                                            staticClass : "row"
                                            ...
                                            function ( a, s ) {
                                                return e( "div", {
                                                    ...
                                                    staticClass : "field",
                                                    class       : a.style,
                                                    domProps    : { innerHTML : t._s( t.generator( a ) ) }
                                                } )
                                            }
                                        ) ), 0 )
                                    }
                        ...
                        ) ), 0 ) : t._e(), t.feed && !t.feed.items.length ? e( "p", { staticClass : "no-activity" }, [ t._v( "You currently have no activity." ) ] ) : t._e()
                    ] )
                }, S = [], A = (
                    a( "6b54" ), {
                        name     : "GeneralFeed",
                        ...
                        methods  : {
                            dateReceived      : function ( t, e ) {
                                var a = new Date( parseInt( t ) ), s = new Date,
                                    n = new Date( s.getFullYear(), s.getMonth(), s.getDate() - 7 );
                                if ( !0 === e ) {
                                    var i = a.getMonth() + 1, r = a.getDate(),
                                        o = a.getFullYear().toString().substring( 2, 4 ),
                                        c = a.getHours() > 11 ? "PM" : "AM", l = (
                                                                                     a.getHours() + 24
                                                                                 ) % 12 || 12,
                                        d = a.getMinutes(),
                                        u = d < 10 ? "0".concat( d ) : d;
                                    return "".concat( i, "/" ).concat( r, "/" ).concat( o, " at " ).concat( l, ":" ).concat( u, " " ).concat( c )
                                }
                                if ( a < n ) {
                                    var f = a.getMonth() + 1, p = a.getDate(),
                                        h = a.getFullYear().toString().substring( 2, 4 );
                                    return "".concat( f, "/" ).concat( p, "/" ).concat( h )
                                }
                                if ( s.getDay() == a.getDay() && s.getMonth() == a.getMonth() ) {
                                    var m = a.getHours() > 11 ? "PM" : "AM", v = (
                                                                                     a.getHours() + 24
                                                                                 ) % 12 || 12,
                                        g = a.getMinutes(),
                                        C = g < 10 ? "0".concat( g ) : g;
                    ...
                    a( "b7fa" ), a( "3366" ), Object( p[ "a" ] )( N, k, S, !1, null, "2609d4e1", null )
                ), O = x.exports, E = function () {
                    var t = this, e = t._self._c;
                    return e( "div", { staticClass : "feed-contain" }, [
                        e( "ul", {
                    ...
                    var t = this, e = t._self._c;
                    return e( "div", { staticClass : "calendar-item clearfix" }, [
                        e( "div", { staticClass : "calendar-datetime" }, [
                            e( "div", { staticClass : "calendar-day" }, [ t._v( t._s( t.formatCalendarFeedDate( t.item.startTime ) ) ) ] ), e( "div", { staticClass : "calendar-time" }, [ t._v( t._s( t.formatDateRange( t.item.startTime, t.item.endTime, t.item.allDayEvent ) ) ) ] ), t.item.hasReminders && t.displayAlert( t.item ) ? e( "div", { staticClass : "calendar-alert" }, [
                                e( "img", {
                                    staticClass : "calendar-alert-icon",
                                    attrs       : { src : a( "2b5f" ) }
                                } ), t._v( "\n    " + t._s( t.displayAlertText( t.item ) ) + "\n    " )
                            ] ) : t._e()
                        ] ), e( "div", { staticClass : "calendar-details" }, [
                            t.item.creatorName ? e( "div", { staticClass : "feed-item-truncate" }, [ t._v( t._s( t.item.creatorName ) ) ] ) : t._e(), t.item.creatorName ? t._e() : e( "div", { staticClass : "feed-item-truncate" }, [ t._v( " " ) ] ), t.item.summary ? e( "div", { staticClass : "feed-item-truncate" }, [
                                t._v( "\n    " + t._s( t.item.summary ) + "\n    " ), t.item.location ? e( "div", { staticClass : "feed-item-truncate calendar-location" }, [ t._v( "\n        " + t._s( t.item.location ) + "\n    " ) ] ) : t._e(), t.item.location ? t._e() : e( "div", { staticClass : "feed-item-truncate calendar-location" }, [ t._v( " " ) ] ), e( "div", { staticClass : "calendar-actions" }, [
                                    e( "button", {
                                        staticClass : "calendar-action",
                                        class       : { "action-taken" : "accepted" === this.eventResponse },
                                        on          : {
                                            click : function ( e ) {
                                        ...
                                        staticClass : "calendar-action",
                                        class       : { "action-taken" : "tentative" === this.eventResponse },
                                        on          : {
                                            click : function ( e ) {
                                        ...
                                        staticClass : "calendar-action",
                                        class       : { "action-taken" : "declined" === this.eventResponse },
                                        on          : {
                                            click : function ( e ) {
                            ...
                            ] ) : t._e(), t.item.summary ? t._e() : e( "div", { staticClass : "feed-item" }, [ t._v( " " ) ] )
                        ] )
                    ] )
                }, $ = [], F = {
                    name     : "CalendarEvent",
                    data     : function () {
                        return { rsvp : { default : "needsAction", type : String } }
                    },
                    watch    : {
                        item : function ( t ) {
                    ...
                    methods  : {
                        updateEventResponse       : function ( t ) {
                            this.rsvp = t, this.$emit( "update", t )
                        }, formatDate             : function ( t ) {
                            var e = new Date( t ), a = e.getHours(),
                                s = e.getMinutes(), n = a >= 12 ? "pm" : "am";
                            a %= 12, a = a || 12, s = s < 10 ? "0" + s : s;
                            var i = a + ":" + s + " " + n;
                            return i
                        }, formatDateRange        : function ( t, e, a ) {
                            if ( a ) return "All Day";
                            var s = this.formatDate( t ), n = this.formatDate( e ),
                                i = s + " - " + n;
                            return i
                            ...
                            if ( e > s ) {
                                ...
                                n = e.toLocaleDateString( "en-US", i )
                            } else if ( e.getDay() === a.getDay() ) n = "Today"; else if ( e.getDay() === a.getDay() + 1 ) n = "Tomorrow"; else {
                                var r = { weekday : "long" };
                                n = e.toLocaleDateString( "en-US", r )
                            }
                            return n
                            ...
                            return a.setMinutes( a.getMinutes() + 60 ), a > s || e > s && e < n
                        }, displayAlertText       : function ( t ) {
                            var e = new Date, a = new Date( t.startTime ),
                                s = new Date( t.endTime );
                            if ( e > a && e < s ) return "NOW";
                            var n = a.getTime() - e.getTime(), i = n / 6e4;
                            return Math.round( i ) + " MIN"
                        }
                    }
                }, I = F, M = (
                    a( "a813" ), Object( p[ "a" ] )( I, P, $, !1, null, "13dc15f7", null )
                ), V = M.exports, z = {
                    name       : "CalendarFeed",
                    components : { CalendarEvent : V },
                    data       : function () {
                        return { classes : null }
                    },
                    props      : { feedType : null },
                    ...
                    methods    : {
                        sendConfirmation          : function ( t, e ) {
                            t.responseStatus = e, this.$store.dispatch( "sendConfirmation", t )
                        }, formatDate             : function ( t ) {
                            var e = new Date( t ), a = e.getHours(),
                                s = e.getMinutes(), n = a >= 12 ? "pm" : "am";
                            a %= 12, a = a || 12, s = s < 10 ? "0" + s : s;
                    ...
                    a( "5749" ), a( "cf5a" ), Object( p[ "a" ] )( j, E, R, !1, null, "6140aeae", null )
                ), U = L.exports, H = (
                    a( "b047c" ), a( "b238" )
                ), G = a( "e5ff" ), Y = a( "0c85" ), B = a( "89cd" ), q = {
                    name          : "BasicCard",
                    components    : {
                        ActionNotice     : o[ "a" ],
                        CollapseSection  : c[ "a" ],
                    ...
                    beforeDestroy : function () {
                        clearInterval( this.googleTimer ), clearInterval( this.classTimer )
                    },
                    computed      : {
                        user                           : function () {
                            return this.$store.state.profile.user
                        }, feed                        : function () {
                            return this.cardProps.feedType && this.$store.state.services.feeds ? this.$store.state.services.feeds[ this.cardProps.feedType ] : { needsGoogleAuth : null }
                        }, maxItems                    : function () {
                    ...
                    methods       : {
                        appendNetidTo                : function ( t, e ) {
                            ...
                            this.googleNotificationDismissed = t, this.$store.dispatch( "dismissGoogle", t )
                        }, openFeed                  : function ( t ) {
                            this.cardProps.userSettings.feedCollapsed = t, this.$store.dispatch( "cardSettings", this.content )
                        }, changeFeed                : function ( t ) {
                            this.cardProps.userSettings.maxVisibleItems = t, this.$store.dispatch( "cardSettings", this.content )
                        }
                    }
                }, J = q, W = (
                    a( "3d7d" ), a( "b6cf" ), Object( p[ "a" ] )( J, i, r, !1, null, "011cd470", null )
                ), Z = W.exports, X = a( "abad" ), K = a( "f344" ),
                Q = function () {
                    var t = this, e = t._self._c;
                    return e( "div", [
                                ...
                                attrs : {
                                    ...
                                    gutter : 30
                                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                       t._l( t.searchResults, (
                                                                                                                                                                                                                                                                                                                                                                                                                                                           function ( a ) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                               return [
                                                                                                                                                                                                                                                                                                                                                                                                                                                                   "promo" != a.cardType && "librariestype" != a.cardType ? e( "basic-card", {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       key   : a.id,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       attrs : { content : a }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                   } ) : t._e(), "promo" == a.cardType ? e( "tutorial-card", {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       key   : a.id,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       attrs : { content : a.notification }
                    ...
                    a( "df39" ), Object( p[ "a" ] )( rt, st, nt, !1, null, null, null )
                ), ct = ot.exports, lt = {
                    name       : "LibraryCard",
                    components : { BasicCard : Z, LibrarySearchEmbed : ct },
                    props      : { content : null },
                    data       : function () {
                        return { presets : { frontTitle : "NYU Libraries" } }
                    }
                }, dt = lt,
                ut = Object( p[ "a" ] )( dt, et, at, !1, null, null, null ),
                ft = ut.exports, pt = {
                    name       : "SearchResults",
                    components : {
                        BasicCard    : Z,
                    ...
                    methods    : {
                        getResults : function () {
                            ...
                            "card" == e ? this.$store.dispatch( "findCardSingle", a ) : "search" == e && this.$store.dispatch( "getSearchResults", a ).then( (
                                                                                                                                                                 function () {
                    ...
                    a( "6ea3" ), Object( p[ "a" ] )( ht, Q, tt, !1, null, "2ef1c3d0", null )
                ), vt = mt.exports, gt = function () {
                    var t = this, e = t._self._c;
                    ...
                    a( "dad8" ), Object( p[ "a" ] )( yt, gt, Ct, !1, null, "195996a3", null )
                ), wt = bt.exports, Tt = a( "9bd9" ), Dt = {
                    name       : "service",
                    components : {
                        DraggableCustomize : Tt[ "a" ],
                        BasicCard          : Z,
                        TutorialCard       : X[ "a" ],
                        LoadAnimation      : K[ "a" ],
                        SearchResults      : vt,
                        ...
                        dismissed          : function ( t ) {
                            if ( t && t.notification && t.userSettings ) {
                                var e = function () {
                                    ...
                                    n = t.notification.beginDate ? t.notification.beginDate : e(),
                                    i = t.notification.endDate ? t.notification.endDate : a(),
                    ...
                    a( "e476" ), Object( p[ "a" ] )( kt, s, n, !1, null, "ce49e084", null )
                );
