export const getitSearch = ({ institution, issn, title, type }) => {
  if (issn) {
    ...
    return `https://getit.library.nyu.edu/search/journal_search?utf8=%E2%9C%93&umlaut.institution=${institution}&rfr_id=info%3Asid%2Fsfxit.com%3Acitation&rft.title=&rft.object_id=&rft.issn=&umlaut.title_search_type=${type}&rft.jtitle=${encodeURI(title)}&Generate_OpenURL2=Search`;
  }
